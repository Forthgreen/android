...
import com.forthgreen.app.viewmodels.NotificationPostDetailsViewModel
import kotlinx.android.synthetic.main.fragment_post_details.*
import kotlinx.android.synthetic.main.fragment_post_details.cbCommentLike
import kotlinx.android.synthetic.main.fragment_post_details.cbLike
import kotlinx.android.synthetic.main.fragment_post_details.cbMute
import kotlinx.android.synthetic.main.fragment_post_details.cbReplyLike
import kotlinx.android.synthetic.main.fragment_post_details.civPostUserImage
import kotlinx.android.synthetic.main.fragment_post_details.civReplyUserImage
import kotlinx.android.synthetic.main.fragment_post_details.civUserImageComments
import kotlinx.android.synthetic.main.fragment_post_details.dotIndicator
import kotlinx.android.synthetic.main.fragment_post_details.etComment
import kotlinx.android.synthetic.main.fragment_post_details.flShimmer
import kotlinx.android.synthetic.main.fragment_post_details.flShimmerComment
import kotlinx.android.synthetic.main.fragment_post_details.groupComment
import kotlinx.android.synthetic.main.fragment_post_details.groupMultiPicturesViews
import kotlinx.android.synthetic.main.fragment_post_details.groupReply
import kotlinx.android.synthetic.main.fragment_post_details.groupVideoPlayer
import kotlinx.android.synthetic.main.fragment_post_details.itemVideoPlayerThumbnail
import kotlinx.android.synthetic.main.fragment_post_details.ivCommentOptions
import kotlinx.android.synthetic.main.fragment_post_details.ivMessage
import kotlinx.android.synthetic.main.fragment_post_details.ivMessageComments
import kotlinx.android.synthetic.main.fragment_post_details.ivPostMenuOptions
import kotlinx.android.synthetic.main.fragment_post_details.ivReplyOptions
import kotlinx.android.synthetic.main.fragment_post_details.nestedScrollView
import kotlinx.android.synthetic.main.fragment_post_details.pbVideo
import kotlinx.android.synthetic.main.fragment_post_details.recyclerView
import kotlinx.android.synthetic.main.fragment_post_details.tvComment
import kotlinx.android.synthetic.main.fragment_post_details.tvCommentLikes
import kotlinx.android.synthetic.main.fragment_post_details.tvComments
import kotlinx.android.synthetic.main.fragment_post_details.tvLikes
import kotlinx.android.synthetic.main.fragment_post_details.tvPostDescription
import kotlinx.android.synthetic.main.fragment_post_details.tvReplies
import kotlinx.android.synthetic.main.fragment_post_details.tvReply
import kotlinx.android.synthetic.main.fragment_post_details.tvReplyLikes
import kotlinx.android.synthetic.main.fragment_post_details.tvSendComment
import kotlinx.android.synthetic.main.fragment_post_details.tvUserFullName
import kotlinx.android.synthetic.main.fragment_post_details.tvUserFullNameComment
import kotlinx.android.synthetic.main.fragment_post_details.tvUserFullNameReply
import kotlinx.android.synthetic.main.fragment_post_details.tvUserName
import kotlinx.android.synthetic.main.fragment_post_details.tvViewMore
import kotlinx.android.synthetic.main.fragment_post_details.tvViewMoreComment
import kotlinx.android.synthetic.main.fragment_post_details.tvViewMoreReply
import kotlinx.android.synthetic.main.fragment_post_details.vViewVideoPlayer
import kotlinx.android.synthetic.main.fragment_post_details.viewPager
import kotlinx.android.synthetic.main.fragment_post_details.viewProfile
import kotlinx.android.synthetic.main.fragment_post_details.vvVideoPlay
 ...
 * @since 03-05-2021
 */
class PostDetailsFragment : BaseRecyclerViewFragment(), View.OnClickListener,
    ...
    companion object {
        ...
        private const val BUNDLE_EXTRAS_POST_ID = "BUNDLE_EXTRAS_POST_ID"
        ...
        fun newInstance(postId: String): PostDetailsFragment {
            return PostDetailsFragment().apply {
                arguments = Bundle().apply {
                    putString(BUNDLE_EXTRAS_POST_ID, postId)
                }
            }
        }
    }
    ...
    private val mNotificationDetailsViewModel by lazy {
        ViewModelProvider(this).get(NotificationPostDetailsViewModel::class.java)
    }
    ...
    private val postId by lazy {
        requireArguments().getString(BUNDLE_EXTRAS_POST_ID, "")
    }
    ...
    override fun setData() {
        ...
        mLocalBroadcastManager.registerReceiver(mLocalBroadcastReceiver, IntentFilter().apply {
            ...
            addAction(LOCAL_INTENT_COMMENTS_ACTION)
        })
    }
    ...
    private fun setupViews() {
        ...
        mNotificationDetailsViewModel.fetchPostDetails(false, postId)
      //  inputMode = requireActivity().window.attributes.softInputMode

        /*nestedScrollView.setOnScrollChangeListener(object : androidx.core.widget.NestedScrollView.OnScrollChangeListener {
...
//            swipeRefreshLayout.visible()
          //  groupAddComment.visible()
            ...
            if (commentsFetched.data.isEmpty() && mPage == 1) {
                ...
                hideNoDataText()
                mPaginationEnabled = commentsFetched.hasMore == true
