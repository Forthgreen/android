...
class ShopCategoriesViewModel(application: Application) : AddBookmarkViewModel(application) {
    ...
    private val mCategoriesFetched = MutableLiveData<PojoProductCategory>()
                ...
                override fun onSuccess(response: Response<*>) {
                    try {
                        ...
                        if (pojoNetworkRequest.isSuccess && response.body() != null) {
                            val pojoProductsCategory = response.body() as PojoProductCategory
    ...
    fun onCategoryFetched(): LiveData<PojoProductCategory> = mCategoriesFetched
}