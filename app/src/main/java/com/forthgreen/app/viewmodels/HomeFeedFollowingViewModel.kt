 ...
 * @since 21-04-2021
 */
class HomeFeedFollowingViewModel(application: Application) : UpdateUserFollowStatusViewModel(application) {
    ...
    fun fetchFeedData(mShowLoader: Boolean, mPage: Int, mResultSize: Int) {
        ...
        mCompositeDisposable.add(mHomeFeedInteractor.getFeedFollowingData(RetrofitUtils.createJsonRequestBody(
                "page" to mPage,
