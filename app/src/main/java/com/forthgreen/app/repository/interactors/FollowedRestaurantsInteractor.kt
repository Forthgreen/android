...
class FollowedRestaurantsInteractor {

    companion object {
        const val TAG = "FollowedRestaurantsInteractor"
    }

    fun getFollowedRestaurants(body: RequestBody, networkRequestCallbacks: NetworkRequestCallbacks): Disposable {
