...
class RestaurantReviewInteractor {

    companion object {
        const val TAG = "RestaurantReviewInteractor"
    }

    fun addRestaurantReview(body: RequestBody, networkRequestCallbacks: NetworkRequestCallbacks): Disposable {
        return RestClient.get().addRestaurantReview(ApplicationGlobal.accessToken, body)
