...
class RateAndReviewInteractor {

    companion object {
        const val TAG = "RateAndReviewInteractor"
    }

    fun getMyReviews(body: RequestBody, networkRequestCallbacks: NetworkRequestCallbacks): Disposable {
