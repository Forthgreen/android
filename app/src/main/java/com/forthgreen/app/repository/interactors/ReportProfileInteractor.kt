 ...
 * @since 03-05-2021
 */
class ReportProfileInteractor {

    companion object {
        private const val TAG = "ReportProfileInteractor"
    }

    fun reportProfile(body: RequestBody, networkRequestCallbacks: NetworkRequestCallbacks): Disposable {
        return RestClient.get().reportUser(ApplicationGlobal.accessToken, body)
