...
class NotificationsInteractor {
    ...
    companion object {
        private const val TAG = "NotificationsInteractor"
    }

    // Hit API via Retrofit
    fun fetchNotifications(body: RequestBody, networkRequestCallbacks: NetworkRequestCallbacks): Disposable {
    ...
    fun markNotifAsSeen(body: RequestBody, networkRequestCallbacks: NetworkRequestCallbacks): Disposable {
