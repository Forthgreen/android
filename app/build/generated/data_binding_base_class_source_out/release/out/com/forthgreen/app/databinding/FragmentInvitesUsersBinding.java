...
public final class FragmentInvitesUsersBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentInvitesUsersBinding(@NonNull SlidingConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentInvitesUsersBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentInvitesUsersBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_invites_users, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentInvitesUsersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentInvitesUsersBinding((SlidingConstraintLayout) rootView, flShimmer, llUsers,
          recyclerView);
    }
