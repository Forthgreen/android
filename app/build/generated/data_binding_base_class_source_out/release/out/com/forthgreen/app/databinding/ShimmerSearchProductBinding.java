...
public final class ShimmerSearchProductBinding implements ViewBinding {
  @NonNull
  ...
  private ShimmerSearchProductBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ShimmerSearchProductBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ShimmerSearchProductBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.shimmer_search_product, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ShimmerSearchProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ShimmerSearchProductBinding((ConstraintLayout) rootView, ciBrandImage, groupBrand,
          groupProduct, ivProduct, tvBrand, tvBrandName, tvProductName);
    }
