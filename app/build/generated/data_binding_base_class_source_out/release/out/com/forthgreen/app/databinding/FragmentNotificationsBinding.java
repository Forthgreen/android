...
public final class FragmentNotificationsBinding implements ViewBinding {
  ...
  private FragmentNotificationsBinding(@NonNull SlidingConstraintLayout rootView,
      @NonNull ShimmerFrameLayout flShimmer, @NonNull LinearLayout llNotifications,
  ...
  public static FragmentNotificationsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.llNotifications;
      LinearLayout llNotifications = rootView.findViewById(id);
      ...
      return new FragmentNotificationsBinding((SlidingConstraintLayout) rootView, flShimmer,
          llNotifications, recyclerView, swipeRefreshLayout, tvNoData);
    }
