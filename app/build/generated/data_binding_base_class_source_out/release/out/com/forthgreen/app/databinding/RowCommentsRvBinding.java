...
public final class RowCommentsRvBinding implements ViewBinding {
  ...
  private RowCommentsRvBinding(@NonNull ConstraintLayout rootView, @NonNull CheckBox cbLike,
      ...
      @NonNull ImageView ivMessage, @NonNull ProgressBar progressBar1, @NonNull TextView tvComment,
      @NonNull TextView tvLikes, @NonNull TextView tvLoadMoreComments, @NonNull TextView tvReplies,
  ...
  public static RowCommentsRvBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RowCommentsRvBinding((ConstraintLayout) rootView, cbLike, civUserImage, cvComment,
          flexBox, guidelineEnd, guidelineStart, ivCommentOptions, ivMessage, progressBar1,
          tvComment, tvLikes, tvLoadMoreComments, tvReplies, tvUserFullName, tvViewMore);
    }
