...
public final class RowInvitesUsersRvBinding implements ViewBinding {
  @NonNull
  ...
  private RowInvitesUsersRvBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnInvite,
      @NonNull CircleImageView civUserImage, @NonNull ConstraintLayout constraint,
      ...
      @NonNull View viewDivider, @NonNull View viewUsersBottomDivider) {
  ...
  @NonNull
  public static RowInvitesUsersRvBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RowInvitesUsersRvBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.row_invites_users_rv, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RowInvitesUsersRvBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.btnInvite;
      Button btnInvite = rootView.findViewById(id);
      if (btnInvite == null) {
        break missingId;
      }
      ...
      return new RowInvitesUsersRvBinding((ConstraintLayout) rootView, btnInvite, civUserImage,
          constraint, guidelineEnd, guidelineStart, tvUserBio, tvUserFullName, tvUserName,
          viewDivider, viewUsersBottomDivider);
    }
