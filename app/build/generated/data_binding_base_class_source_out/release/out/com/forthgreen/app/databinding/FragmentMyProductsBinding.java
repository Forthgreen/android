...
public final class FragmentMyProductsBinding implements ViewBinding {
  ...
  private FragmentMyProductsBinding(@NonNull SlidingConstraintLayout rootView,
      @NonNull ShimmerFrameLayout flShimmer, @NonNull LinearLayout llProducts,
  ...
  public static FragmentMyProductsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMyProductsBinding((SlidingConstraintLayout) rootView, flShimmer,
          llProducts, recyclerView, swipeRefreshLayout, tvNoData);
    }
