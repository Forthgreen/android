...
public final class RowShopProductsRvBinding implements ViewBinding {
  @NonNull
  ...
  private RowShopProductsRvBinding(@NonNull SlidingConstraintLayout rootView,
  ...
  @NonNull
  public static RowShopProductsRvBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RowShopProductsRvBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.row_shop_products_rv, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RowShopProductsRvBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RowShopProductsRvBinding((SlidingConstraintLayout) rootView, cbBookmark,
