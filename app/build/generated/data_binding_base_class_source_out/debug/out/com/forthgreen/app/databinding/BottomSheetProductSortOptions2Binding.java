...
public final class BottomSheetProductSortOptions2Binding implements ViewBinding {
  @NonNull
  ...
  private BottomSheetProductSortOptions2Binding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static BottomSheetProductSortOptions2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static BottomSheetProductSortOptions2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.bottom_sheet_product_sort_options2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static BottomSheetProductSortOptions2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new BottomSheetProductSortOptions2Binding((ConstraintLayout) rootView, guidelineEnd,
