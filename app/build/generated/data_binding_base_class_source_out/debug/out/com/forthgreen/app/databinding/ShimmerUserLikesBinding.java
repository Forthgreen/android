...
public final class ShimmerUserLikesBinding implements ViewBinding {
  @NonNull
  ...
  private ShimmerUserLikesBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ShimmerUserLikesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ShimmerUserLikesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.shimmer_user_likes, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ShimmerUserLikesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ShimmerUserLikesBinding((ConstraintLayout) rootView, civUserImage, guidelineEnd,
          guidelineStart, tvUserFullName, viewDivider);
    }
