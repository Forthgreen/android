...
public final class RowSearchProductBinding implements ViewBinding {
  @NonNull
  ...
  private RowSearchProductBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static RowSearchProductBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RowSearchProductBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.row_search_product, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RowSearchProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RowSearchProductBinding((ConstraintLayout) rootView, ciBrandImage, groupBrand,
