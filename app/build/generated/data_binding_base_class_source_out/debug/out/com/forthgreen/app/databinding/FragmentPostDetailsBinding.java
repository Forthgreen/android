...
public final class FragmentPostDetailsBinding implements ViewBinding {
  ...
  private FragmentPostDetailsBinding(@NonNull SlidingConstraintLayout rootView,
      ...
      @NonNull TextView tvSendComment, @NonNull TextView tvUserFullName,
      ...
      @NonNull View vViewVideoPlayer, @NonNull View viewBottom, @NonNull View viewBottomDivider,
      @NonNull View viewCommentTop, @NonNull ViewPager2 viewPager, @NonNull View viewPictureDivider,
      @NonNull View viewProfile, @NonNull VideoView vvVideoPlay) {
  ...
  public static FragmentPostDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPostDetailsBinding((SlidingConstraintLayout) rootView, cbCommentLike,
          cbLike, cbMute, cbReplyLike, civPostUserImage, civReplyUserImage, civUserImageComments,
          cvComment, cvReply, dotIndicator, etComment, flShimmer, flShimmerComment, flexBox,
          ...
          ivMessageComments, ivPostMenuOptions, ivReplyOptions, llComments, llPostDetails,
          nestedScrollView, pbVideo, recyclerView, tvComment, tvCommentLikes, tvComments, tvLikes,
          tvLoadMoreComments, tvPostDescription, tvReplies, tvReply, tvReplyLikes, tvSendComment,
          tvUserFullName, tvUserFullNameComment, tvUserFullNameReply, tvUserName, tvViewMore,
          tvViewMoreComment, tvViewMoreReply, vViewVideoPlayer, viewBottom, viewBottomDivider,
          viewCommentTop, viewPager, viewPictureDivider, viewProfile, vvVideoPlay);
    }
