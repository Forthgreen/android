...
public final class DialogDeleteAccountBinding implements ViewBinding {
  ...
  private DialogDeleteAccountBinding(@NonNull SlidingConstraintLayout rootView,
      @NonNull TextView tvCancel, @NonNull TextView tvOk) {
  ...
  public static DialogDeleteAccountBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogDeleteAccountBinding((SlidingConstraintLayout) rootView, tvCancel, tvOk);
    }
