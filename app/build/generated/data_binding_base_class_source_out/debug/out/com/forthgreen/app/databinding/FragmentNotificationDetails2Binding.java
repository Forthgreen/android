...
public final class FragmentNotificationDetails2Binding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ShimmerFrameLayout flShimmerComment;
  ...
  private FragmentNotificationDetails2Binding(@NonNull SlidingConstraintLayout rootView,
      ...
      @NonNull SpringDotsIndicator dotIndicator, @NonNull EditText etComment,
      @NonNull ShimmerFrameLayout flShimmer, @NonNull ShimmerFrameLayout flShimmerComment,
      ...
      @NonNull LinearLayout llComments, @NonNull LinearLayout llPostDetails,
      @NonNull NestedScrollView nestedScrollView, @NonNull ProgressBar pbVideo,
      @NonNull RecyclerView recyclerView, @NonNull TextView tvComment,
      @NonNull TextView tvCommentLikes, @NonNull TextView tvComments, @NonNull TextView tvLikes,
      @NonNull TextView tvLoadMoreComments, @NonNull TextView tvPostDescription,
      @NonNull TextView tvReplies, @NonNull TextView tvReply, @NonNull TextView tvReplyLikes,
      @NonNull TextView tvSendComment, @NonNull TextView tvTransparent,
      @NonNull TextView tvUserFullName, @NonNull TextView tvUserFullNameComment,
      @NonNull TextView tvUserFullNameReply, @NonNull TextView tvUserName,
      @NonNull TextView tvViewMore, @NonNull TextView tvViewMoreComment,
      @NonNull TextView tvViewMoreReply, @NonNull View vViewVideoPlayer, @NonNull View viewBottom,
      @NonNull View viewBottomDivider, @NonNull View viewCommentTop, @NonNull ViewPager2 viewPager,
      @NonNull View viewPictureDivider, @NonNull View viewProfile, @NonNull VideoView vvVideoPlay) {
    ...
    this.flShimmerComment = flShimmerComment;
    ...
    this.tvSendComment = tvSendComment;
  ...
  @NonNull
  public static FragmentNotificationDetails2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentNotificationDetails2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_notification_details2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentNotificationDetails2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.flShimmerComment;
      ShimmerFrameLayout flShimmerComment = rootView.findViewById(id);
      if (flShimmerComment == null) {
        break missingId;
      }
      ...
      id = R.id.tvSendComment;
      TextView tvSendComment = rootView.findViewById(id);
      if (tvSendComment == null) {
        break missingId;
      }

      id = R.id.tv_transparent;
      TextView tvTransparent = rootView.findViewById(id);
      if (tvTransparent == null) {
        break missingId;
      }
      ...
      return new FragmentNotificationDetails2Binding((SlidingConstraintLayout) rootView,
          cbCommentLike, cbLike, cbMute, cbReplyLike, civPostUserImage, civReplyUserImage,
          civUserImageComments, cvComment, cvReply, dotIndicator, etComment, flShimmer,
          flShimmerComment, flexBox, flexBoxComments, groupComment, groupMultiPicturesViews,
          groupReply, groupVideoPlayer, guidelineCardEnd, guidelineCardStart, guidelineEnd,
          guidelineEndReply, guidelineStart, guidelineStartReply, itemVideoPlayerThumbnail,
          ivCommentOptions, ivMessage, ivMessageComments, ivPostMenuOptions, ivReplyOptions,
          llComments, llPostDetails, nestedScrollView, pbVideo, recyclerView, tvComment,
          tvCommentLikes, tvComments, tvLikes, tvLoadMoreComments, tvPostDescription, tvReplies,
          tvReply, tvReplyLikes, tvSendComment, tvTransparent, tvUserFullName,
          tvUserFullNameComment, tvUserFullNameReply, tvUserName, tvViewMore, tvViewMoreComment,
          tvViewMoreReply, vViewVideoPlayer, viewBottom, viewBottomDivider, viewCommentTop,
          viewPager, viewPictureDivider, viewProfile, vvVideoPlay);
    }
